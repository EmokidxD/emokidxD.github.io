...
// Group of iOS < 15 specific hooks.
%group Fallback

	// Achieves the same effect as hooking CSCoverSheet, but on iOS <= 15.
...
%group FixBlur
	...
	%hook SBWallpaperEffectView 
		...
		-(void) didMoveToWindow {
			...
			// Wallpaper style 12 -> SBDockView's underlying blur (iOS <= 15)
